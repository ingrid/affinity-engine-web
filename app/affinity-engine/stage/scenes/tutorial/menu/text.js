...
export default Scene.extend(ReplayableScriptMixin, {
  start: task(function * (script) {
    yield script.menu(['engines.tutorial.menu.kale.text', 'engines.tutorial.menu.kimchi.text', 'engines.tutorial.menu.almonds.text'], { text: 'engines.tutorial.menu.text1' });
