...
export default Scene.extend(ReplayableScriptMixin, {
  start: task(function * (script) {
    ...
    script.text('engines.tutorial.basics.caption.scene1', { classNames: 'ae-paper ae-caption ae-caption-center', fixed: true });
    ...
    script.scene('tutorial.text.static.b', { autosave: false });
  })
});
