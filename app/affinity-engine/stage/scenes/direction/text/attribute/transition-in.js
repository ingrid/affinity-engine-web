...
export default Scene.extend(ReplayableScriptMixin, {
    start: task(function * (script) {
      ...
      yield script.text('engines.direction.text.attribute.transition-in.diy2', { caption: 'engines.direction.text.attribute.transition-in.diy', transitionIn: { effect: { translateX: ['0%', '-100%'], opacity: [1, 1]}, duration: 1200 }, instant: true });
