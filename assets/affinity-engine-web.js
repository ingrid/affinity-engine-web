...
define('affinity-engine-web/components/m-intl', ['exports', 'ember', 'markdown-it', 'affinity-engine-web/utils/markdown-it-highlight'], function (exports, _ember, _markdownIt, _affinityEngineWebUtilsMarkdownItHighlight) {
  ...
  function scrollToAnchor(anchor) {
    if (anchor) {
      var position = _ember['default'].$('a[name="' + anchor + '"]').position();
    ...
    "en-us": {
      "0_1_0": {
        "api": {
          ...
          "fixtures": {
            "defaultState.md": "An Object describing the default [state](#/engine/fixtures/images?anchor=state) of the fixture.\n",
...
define('affinity-engine-web/routes/components/stage/scenes/data', ['exports', 'ember', 'affinity-engine-web/mixins/reset-scroll', 'affinity-engine-web/mixins/route-title'], function (exports, _ember, _affinityEngineWebMixinsResetScroll, _affinityEngineWebMixinsRouteTitle) {
  var Route = _ember['default'].Route;
  exports['default'] = Route.extend(_affinityEngineWebMixinsResetScroll['default'], _affinityEngineWebMixinsRouteTitle['default']);
});
define('affinity-engine-web/routes/components/stage/scenes/index', ['exports', 'ember', 'affinity-engine-web/mixins/reset-scroll', 'affinity-engine-web/mixins/route-title'], function (exports, _ember, _affinityEngineWebMixinsResetScroll, _affinityEngineWebMixinsRouteTitle) {
  var Route = _ember['default'].Route;
  exports['default'] = Route.extend(_affinityEngineWebMixinsResetScroll['default'], _affinityEngineWebMixinsRouteTitle['default']);
});
