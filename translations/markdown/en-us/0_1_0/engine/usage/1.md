...
* `config`: an object containing configuration values; detailed in its own [section](/overview/configuration).

* `fixtures`: a map of game objects; detailed in its own [section](/overview/fixtures).
